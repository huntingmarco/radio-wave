...
<head>
	<meta charset="utf-8">
	<title>Path Data Editing Details</title>
	<link href="../css/style.css" type="text/css" rel="stylesheet"/>
	<script src="../js/jquery-3.2.1.js"></script>
	<script src="js/formEditPath_ajax.js"></script> 	
	
</head>
<body>
	<h2> Information List</h2>
	<span style="font-weight:bold">[Note] Please, choose a path data then click the 'Edit Details' button to edit path</span><br><br><br>

	<form method="POST" id="DetailsForm" onsubmit="return validateEditDetails()">
	<?php 
		displayData();
		$db_conn= NULL;
	?>
	<br>
	<p>
	<input type="submit" id="editDetails" name="edit" value="Edit Details"/>
	</p>
	</form>
